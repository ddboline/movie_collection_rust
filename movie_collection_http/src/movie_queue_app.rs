    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(web::scope("/list")
                ...
                .service(web::resource("/delete/{path}").route(web::get().to(movie_queue_delete)))
                .service(
                    web::resource("/transcode/{file}").route(web::get().to(movie_queue_transcode)),
                )
                .service(
                ...
                .service(web::resource("/trakt/refresh_auth").route(web::get().to(refresh_auth)))
                .service(web::resource("/trakt/cal").route(web::get().to(trakt_cal)))
                .service(web::resource("/trakt/watchlist").route(web::get().to(trakt_watchlist)))
                .service(
                ...
                .service(web::resource("/last_modified").route(web::get().to(last_modified_route)))
